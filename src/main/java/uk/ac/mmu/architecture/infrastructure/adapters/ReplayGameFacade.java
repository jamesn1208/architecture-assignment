...
import uk.ac.mmu.architecture.infrastructure.adapters.ConsoleGameOutputAdapter;
import uk.ac.mmu.architecture.infrastructure.adapters.ConsoleStateOutputAdapter;
import uk.ac.mmu.architecture.infrastructure.states.GameReady;

import java.util.List;

/**
 * Infrastructure-side facade used to wire a replay Game with console adapters.
 * This class lives in infra so it may reference concrete infra observers/adapters.
 */
public class ReplayGameFacade {
  ...
  public ReplayGameFacade(
    ...
    this.replayGame = new Game(board, replayRuleset, gameObservers, stateObservers, state);
  }
