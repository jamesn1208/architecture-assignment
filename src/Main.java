...
public class Main {
    public static void main(String[] args) {
        ...
        // Standard
        Ruleset standardRules = new Ruleset(2, 2, new StandardWinCondition(), new StandardHitCondition());
        ...
        System.out.println("Simulation Breakdown:\n" +
                "Games Played: " + winners.size() + "\n" +
                "Winners: " + winners);
    }
}